...
elastic_tensor = get_vasp_tensor('OUTCAR')
...
for vec in Cij:
    print('{:5.5f} {:5.5f} {:5.5f} {:5.5f} {:5.5f} {:5.5f}'.format(vec[0], vec[1], vec[2], vec[3], vec[4], vec[5]))


# ### Elastic tensor $C_{ij}$
elastic_tensor = get_quip_tensor('quip.result')
