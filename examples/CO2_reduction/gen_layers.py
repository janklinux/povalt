...
for i in range(4):
    for j in range(4):
        atom.append([2.0 + i*prd, 2.0 + j*prd, 8.0])
        species.append('Cu')
        atom.append([0.0 + i*prd, 2.0 + j*prd, 8.0])
        species.append('Ir')
        atom.append([2.0 + i*prd, 0.0 + j*prd, 8.0])
        species.append('Pt')
...
for l in cell.lattice.matrix:
    new_lattice.append(l)
