...
train_split = {'fcc_Cu': 0.15, 'bcc_Cu': 0.15, 'hcp_Cu': 0.15, 'sc_Cu': 0.15, 'slab_Cu': 0.45,
               'fcc_Au': 0.15, 'bcc_Au': 0.15, 'hcp_Au': 0.15, 'sc_Au': 0.15, 'slab_Au': 0.45,
...
# print('Slecetion process adoption due to Pt results')
# print('May be good to select differently for Cu then for Au')
# print('Separate counters needed...?')
# quit()
    ...
    for csys in systems:
        ...
        for ci, species in enumerate(['Cu', 'Au']):
            ...
            with tf.device('/device:CPU:0'):
                ...
                print('selected {} {} xyz'.format(len(added), species))
